...
class MarkCompleteDialog(QDialog):
    ...
    def get_project_description(self):
        ...
        return self.controller.get_single_project(self.project_id,user)[0][1]
...
class MarkProjectCompleteDialog(MarkCompleteDialog):
    ...
    def __init__(self, project_id):
        ...
        self.setWindowTitle("Mark Category Complete")

        self.project_completed_message = QLabel("All tasks for this Category are completed.")
        self.mark_project_complete_message = QLabel("Mark Category complete?")
...
class MarkProjectTasksCompleteDialog(MarkCompleteDialog):
    ...
    def __init__(self, project_id):
        ...
        self.setWindowTitle("Mark Category Tasks Complete")

        self.project_tasks_message = QLabel("Some tasks for this Category are not yet completed.")
        self.mark_project_tasks_complete_message = QLabel("Mark all Category tasks complete?")
