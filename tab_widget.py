...
from todolist_button import *
from todolist_table import *
from add_new_list import *
from mark_complete_todolist import *
from edit_todolist import *
from delete_todolist import *
from category_todolist import *
...
class TaskProjectTabs(QWidget):
    ...
    def __init__(self):
        ...
        self.tabs.addTab(self.projects_tab, "Category")
             
        self.tasks_radio_buttons = RadioButtonWidget(['Active Tasks', 'Completed Tasks', 'All Tasks'])
        self.projects_radio_buttons = RadioButtonWidget(['Active Categories', 'Completed Categories', 'All Categories'])
        ...
        self.tasks_sort_combobox.addItems(["Title","Decription", "Duedate", "Created", "Completed", "CategoryID"])
        ...
        self.projects_sort_combobox.addItems(["ProjectID", "Decription", "Duedate", "Created", "Completed"])
        ...
        self.new_project_button = QPushButton("Create New")
        self.project_tasks_button = QPushButton("View Category Tasks")
        ...
        self.project_edit_button = QPushButton("Update")
