...
class NewTaskDialog(AddNewDialog):
    ...
    def add_new_task(self):
        ...
        self.controller.add_task(description, deadline, project_id, user)
        self.close()
...
class NewProjectTaskDialog(NewTaskDialog):
    ...
    def add_new_task(self):
        ...
        if self.no_deadline_checkbox.isChecked():
            ...
            deadline = self.deadline_calendar_widget.selectedDate().toPyDate()
        self.controller.add_task(description, deadline, self.project_id,user)
        self.close()
...
class NewProjectDialog(AddNewDialog):
    ...
    def add_new_project(self):
        ...
        if self.no_deadline_checkbox.isChecked():
            ...
            deadline = self.deadline_calendar_widget.selectedDate().toPyDate()
        self.controller.add_project(description, deadline,user)
        self.close()
