...
class DeleteProjectDialog(QDialog):
    ...
    def __init__(self, project_id):
        ...
        self.delete_project_message_label = QLabel("Delete this Category and all associated tasks?")

        self.delete_project_tasks_button = QPushButton("Delete Category and tasks")
        self.delete_project_only_button = QPushButton("Delete Category only")
    ...
    def delete_project_and_tasks(self):
        ...
        delete_project_tasks_confirmation.setWindowTitle("Category deleted")
        delete_project_tasks_confirmation.setInformativeText("Category and associated tasks deleted")
    ...
    def delete_project_only(self):
        ...
        delete_project_only_confirmation.setWindowTitle("Category deleted")
        delete_project_only_confirmation.setInformativeText("Associated tasks are no longer assigned to any Category")
