...
class EditTaskDialog(EditDialog):
    ...
    def __init__(self, task_id):
        ...
        self.setWindowTitle("Edit TODO Task")
        self.task_details = self.get_task_details(user)
        ...
        if self.task_details[0][2] == None:
            ...
            self.deadline_calendar_widget.setEnabled(False)
        self.project_assign_label = QLabel("Assign to Category folder")
        self.project_assign_combobox = QComboBox()
        self.project_assign_combobox.addItem("None")
        project_list = self.get_project_list(user)
    ...
    def get_task_details(self,user):
        task_details = self.controller.get_single_task(self.task_id,user)
        return task_details

    def get_project_list(self,user):
        project_list = []
        for entry in self.controller.get_all_projects(user):
...
class EditProjectDialog(EditDialog):
    ...
    def __init__(self, project_id):
        ...
        self.project_details = self.get_project_details(user)
    ...
    def get_project_details(self,user):
        project_details = self.controller.get_single_project(self.project_id,user)
